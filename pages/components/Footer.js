...
const FooterMain = tw.div`w-full flex flex-col items-start gap-16 text-lg md:flex-row`;
const FooterLinks = tw.div` flex flex-col gap-5 `;
const FooterText = tw.div`w-full`;
const Socials = tw.div`flex gap-5 md:flex-col`;
const AllRIghts = tw.div`w-full flex flex-col items-start md:flex-row md:items-end md:justify-between`;
